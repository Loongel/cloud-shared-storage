...
```sh
./scripts/cs-storage-build-deb.sh --version 0.1.5
```
...
sh /tmp/cs-storage-install.sh \
  --deb-url https://github.com/Loongel/cloud-shared-storage/releases/download/v0.1.5/cs-storage_0.1.5_amd64.deb \
  --role all \
  --driver-name css \
