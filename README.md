...
```sh
./scripts/cs-storage-build-deb.sh --version 0.1.15
```
...
sh /tmp/cs-storage-install.sh \
  --deb-url https://github.com/Loongel/cloud-shared-storage/releases/download/v0.1.15/cs-storage_0.1.15_amd64.deb \
  --role all \
  --driver-name css \
