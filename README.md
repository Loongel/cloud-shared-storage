...
```sh
./scripts/cs-storage-build-deb.sh --version 0.1.3
```
...
sh /tmp/cs-storage-install.sh \
  --deb-url https://github.com/Loongel/cloud-shared-storage/releases/download/v0.1.3/cs-storage_0.1.3_amd64.deb \
  --role all \
  --driver-name css \
...
DEB_BUILD_OK path=dist/cs-storage_0.1.3_amd64.deb sha256=2efe1783999cf59e9773ff52f23545940184550dc7a3171115c59c9a0345d7bd compression=control.tar.xz source=GitHub-Actions
